...
namespace Contracts.Contracts.IPancakeRouter01.ContractDefinition
{


    public partial class IPancakeRouter01Deployment : IPancakeRouter01DeploymentBase
    {
        public IPancakeRouter01Deployment() : base(BYTECODE) { }
        public IPancakeRouter01Deployment(string byteCode) : base(byteCode) { }
    }

    public class IPancakeRouter01DeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "";
        public IPancakeRouter01DeploymentBase() : base(BYTECODE) { }
        public IPancakeRouter01DeploymentBase(string byteCode) : base(byteCode) { }
