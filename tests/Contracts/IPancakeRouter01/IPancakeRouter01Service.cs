...
using Contracts.Contracts.IPancakeRouter01.ContractDefinition;

namespace Contracts.Contracts.IPancakeRouter01
{
    public partial class IPancakeRouter01Service
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, IPancakeRouter01Deployment iPancakeRouter01Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<IPancakeRouter01Deployment>().SendRequestAndWaitForReceiptAsync(iPancakeRouter01Deployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, IPancakeRouter01Deployment iPancakeRouter01Deployment)
        {
            return web3.Eth.GetContractDeploymentHandler<IPancakeRouter01Deployment>().SendRequestAsync(iPancakeRouter01Deployment);
        }

        public static async Task<IPancakeRouter01Service> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, IPancakeRouter01Deployment iPancakeRouter01Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, iPancakeRouter01Deployment, cancellationTokenSource);
            return new IPancakeRouter01Service(web3, receipt.ContractAddress);
        }
        ...
        public IPancakeRouter01Service(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
