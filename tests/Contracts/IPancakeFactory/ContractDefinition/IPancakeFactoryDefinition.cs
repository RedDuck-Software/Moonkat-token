...
namespace Contracts.Contracts.IPancakeFactory.ContractDefinition
{


    public partial class IPancakeFactoryDeployment : IPancakeFactoryDeploymentBase
    {
        public IPancakeFactoryDeployment() : base(BYTECODE) { }
        public IPancakeFactoryDeployment(string byteCode) : base(byteCode) { }
    }

    public class IPancakeFactoryDeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "";
        public IPancakeFactoryDeploymentBase() : base(BYTECODE) { }
        public IPancakeFactoryDeploymentBase(string byteCode) : base(byteCode) { }
