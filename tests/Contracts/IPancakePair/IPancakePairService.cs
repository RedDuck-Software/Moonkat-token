...
using Contracts.Contracts.IPancakePair.ContractDefinition;

namespace Contracts.Contracts.IPancakePair
{
    public partial class IPancakePairService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, IPancakePairDeployment iPancakePairDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<IPancakePairDeployment>().SendRequestAndWaitForReceiptAsync(iPancakePairDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, IPancakePairDeployment iPancakePairDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<IPancakePairDeployment>().SendRequestAsync(iPancakePairDeployment);
        }

        public static async Task<IPancakePairService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, IPancakePairDeployment iPancakePairDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, iPancakePairDeployment, cancellationTokenSource);
            return new IPancakePairService(web3, receipt.ContractAddress);
        }
        ...
        public IPancakePairService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
