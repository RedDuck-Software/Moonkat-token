...
namespace Contracts.Contracts.IPancakePair.ContractDefinition
{


    public partial class IPancakePairDeployment : IPancakePairDeploymentBase
    {
        public IPancakePairDeployment() : base(BYTECODE) { }
        public IPancakePairDeployment(string byteCode) : base(byteCode) { }
    }

    public class IPancakePairDeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "";
        public IPancakePairDeploymentBase() : base(BYTECODE) { }
        public IPancakePairDeploymentBase(string byteCode) : base(byteCode) { }
