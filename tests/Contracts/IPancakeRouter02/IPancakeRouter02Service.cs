...
using Contracts.Contracts.IPancakeRouter02.ContractDefinition;

namespace Contracts.Contracts.IPancakeRouter02
{
    public partial class IPancakeRouter02Service
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, IPancakeRouter02Deployment iPancakeRouter02Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<IPancakeRouter02Deployment>().SendRequestAndWaitForReceiptAsync(iPancakeRouter02Deployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, IPancakeRouter02Deployment iPancakeRouter02Deployment)
        {
            return web3.Eth.GetContractDeploymentHandler<IPancakeRouter02Deployment>().SendRequestAsync(iPancakeRouter02Deployment);
        }

        public static async Task<IPancakeRouter02Service> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, IPancakeRouter02Deployment iPancakeRouter02Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, iPancakeRouter02Deployment, cancellationTokenSource);
            return new IPancakeRouter02Service(web3, receipt.ContractAddress);
        }
        ...
        public IPancakeRouter02Service(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
