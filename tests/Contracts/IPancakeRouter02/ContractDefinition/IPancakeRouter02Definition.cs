...
namespace Contracts.Contracts.IPancakeRouter02.ContractDefinition
{


    public partial class IPancakeRouter02Deployment : IPancakeRouter02DeploymentBase
    {
        public IPancakeRouter02Deployment() : base(BYTECODE) { }
        public IPancakeRouter02Deployment(string byteCode) : base(byteCode) { }
    }

    public class IPancakeRouter02DeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "";
        public IPancakeRouter02DeploymentBase() : base(BYTECODE) { }
        public IPancakeRouter02DeploymentBase(string byteCode) : base(byteCode) { }
