...
contract PreSaleClaimer is Ownable{ 
    ...
    function _hardcodeAddresses() private {
       _addTokenClaimer(address(0x03CE7ad9E91Ca95576B90B00B780328677c8DC5F), 1500000000000000, 432000000000000);
        _addTokenClaimer(address(0x05Fb9594BbF49979D5Ca5c95a913BF4995F4C096), 1500000000000000, 432000000000000);
        _addTokenClaimer(address(0x06e5a9feb9e33BCae23a2f53E70A513fba96bc77), 1000000000000000, 480000000000000);
        _addTokenClaimer(address(0x0bA2f9edB9734F5c6715F86079649f3814C5Fd98), 5000000000000000, 2400000000000000);
        _addTokenClaimer(address(0x0E08d3048c5435d30eF83c55915227e3ca4Aa3BA), 2100000000000000, 1008000000000000);
        _addTokenClaimer(address(0x0Ec8BC018C50502254A1f257471698212bC54cC7), 750000000000000, 216000000000000);
        _addTokenClaimer(address(0x14318237a1f45792533eB5A34925245f17a4F660), 4200000000000000, 2016000000000000);
        _addTokenClaimer(address(0x19689D6f4AD16bdec73f9648326A38C27BfBe961), 1500000000000000, 432000000000000);
        ...
        _addTokenClaimer(address(0x4fE52b35Cc196Ac681f2fF2b6455A50c3Ad96929), 1501811000000000, 720869280000000);
